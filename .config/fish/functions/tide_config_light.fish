...
function tide_config_light --description "Set variables for a light fish tide config"
    ...
    set --global tide_left_prompt_items private_mode pwd context shlvl git status newline character
